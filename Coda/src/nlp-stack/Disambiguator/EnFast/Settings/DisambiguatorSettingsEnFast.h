...
#ifndef DISAMBIGUATOR_SETTINGS_EN_FAST
#define DISAMBIGUATOR_SETTINGS_EN_FAST
...
class DisambiguatorSettingsEnFast : public IDisambiguatorSettings
{
public:
    typedef Tools::LessFunctor<38220> TrainingFunctor;
    typedef Tools::MoreFunctor<43714> TestFunctor;

    DisambiguatorSettingsEnFast();
...
#endif // DISAMBIGUATOR_SETTINGS_EN_FAST
