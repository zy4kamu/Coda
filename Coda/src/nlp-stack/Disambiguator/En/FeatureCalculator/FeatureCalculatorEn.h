...
#ifndef _FEATURE_CALCULATOR_EN
#define _FEATURE_CALCULATOR_EN
...
class FeatureCalculatorEn
    : public IFeatureCalculator
{

public:
    FeatureCalculatorEn(shared_ptr<MorphologicalDictionary> dictionary
