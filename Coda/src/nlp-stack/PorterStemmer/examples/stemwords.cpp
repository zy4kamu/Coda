...
//void stemWord(struct sb_stemmer * stemmer, const string& word)
//{
//    unsigned char* a = (unsigned char*)word.c_str();
//    sb_symbol* source = a;
//    const sb_symbol* res = sb_stemmer_stem(stemmer,source,word.size());
//    printf("%s\n",res);
//}
...
//    stemmer::PorterStemmer<> st("english");
//    string str;
//    while (1)
//    {
//        std::cin>>str;
